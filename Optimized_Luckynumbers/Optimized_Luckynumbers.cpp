...
size_t refactored_getLuckyNumbers4(size_t N) {
	...
	printf("algoloop ran %llu times, ", loopcounter);
	return luckiesTotal;
...
int main() {
	...
	std::cout << "give 1 to 18 digit unsigned integer as input to calculate luckynumbers_Count from range [1,N]" << std::endl;
	std::cin >> userinput;
